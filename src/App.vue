        ...
        <div class="skills-grid">
          <div class="skill-category animate-on-scroll" data-animation="fadeInLeft">
            ...
            <div class="skill-items">
              <div class="skill-item animate-on-scroll" v-for="(skill, index) in frontendSkills.slice(0, 5)" :key="skill.name" 
                ...
                <div class="skill-icon">
                  ...
                  <svg v-else-if="skill.icon === 'react-logo'" class="react-logo" xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 32 32" fill="none">
                  ...
                  <svg v-else-if="skill.icon === 'git-logo'" class="git-logo" xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 32 32" fill="none">
          ...
          <div class="skill-category animate-on-scroll" data-animation="fadeInRight">
            ...
            <div class="skill-items">
              <div class="skill-item animate-on-scroll" v-for="(skill, index) in frontendSkills.slice(5)" :key="skill.name" 
                   data-animation="fadeInUp" :data-delay="index * 100">
                <div class="skill-icon">
                  <svg v-if="skill.icon === 'html-logo'" class="html-logo" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M1.5 0h21l-1.91 21.563L11.977 24l-8.564-2.438L1.5 0zm7.031 9.75l-.232-2.718 10.059.003.23-2.622L5.412 4.41l.698 8.01h9.126l-.326 3.426-2.91.804-2.955-.81-.188-2.11H6.248l.33 4.171L12 19.351l5.379-1.443.744-8.157H8.531z"/>
